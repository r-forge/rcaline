...
expect_that(STRte_BAAQMD_v3, is_a('SpatialLinesDataFrame'))
...
# met_5801 is provided by package data
expect_message(met <- Meteorology(met_5801, use='urban')[1:3,], '2 wind speeds less than 1.0 m/s')
